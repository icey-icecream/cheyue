  ...
  <div>
    ...
    <div class="login-form">
      ...
      <el-form :model="ruleForm2" status-icon :rules="rules2" ref="ruleForm2" class="demo-ruleForm">
        ...
        <el-form-item>
          <button style="width:274px;border:none;color:#fff;background:#ED3636" @click.prevent="submitForm('ruleForm2')">确认重置</button>
        </el-form-item>
      </el-form>
      </div>
    </div>
    ...
    methods: {
      submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.axios.get(this.common.projectName_ + 'user/updatePassword.action?',{
              params : {
